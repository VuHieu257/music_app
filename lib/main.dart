...
class _UserSearchPageState extends State<UserSearchPage> {
  ...
  // Hàm để tìm kiếm user từ Firestore
  Stream<QuerySnapshot> searchUsers(String keyword) {
    return FirebaseFirestore.instance
        .collection('db_user')
        .where('lowercaseDisplayName',
        ...
        children: [
          ...
          Expanded(
            child: StreamBuilder<QuerySnapshot>(
              stream: searchUsers(_searchKeyword),
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return FutureBuilder(
                        future:
                            firestore.collection('db_user').doc(otherUserId).get(),
                        builder: (context,
